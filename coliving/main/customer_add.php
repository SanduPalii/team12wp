...
<body>
    ...
    <div class="form-group">
            <button type="submit" class="descr_btn btn_save" name= "submit" href="customer_list.php">Customer list</button>
        </div>
    <form  name="addcustomer" method="post" onsubmit="return validateForm()">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone" class="form-control"placeholder="Enter the numbers of Beds">
        </div>
        <div class="form-group">
