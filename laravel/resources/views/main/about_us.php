    ...
    <div class="container">
        <div class="info_wrapper">
            ...
            <div class="catalog_image info_cat">
                <img src="/laravel/public/img/about_img1.png" alt="catalog" onclick="zoomOn('/laravel/public/img/about_img1.png')">
            </div>
        </div>
        <div class="info_wrapper">
            <div class="info__data">
            ...
            <div class="catalog_image info_cat">
                <img src="/laravel/public/img/about_img2.png" alt="catalog" onclick="zoomOn('img/about_img2.png')">
            </div>
        </div>
    </div>
</section>
