...
<section class="apartment" id="apartment">
    <div class="container">
        ...
        <div class="catalog">
            <div class="catalog_wrapper">
                <div class="catalog_image">
                    <img src="/laravel/public/img/catalog.png" alt="catalog" onclick="zoomOn('/laravel/public/img/catalog.png')">
                </div>
        ...
        <div class="catalog" id="catalog">
            <div class="catalog_wrapper">
                <div class="catalog_image">
                    <img src="/laravel/public/img/catalog2.jpg" class="catalog2" alt="catalog" onclick="zoomOn('/laravel/public/img/catalog2.jpg')">
                </div>
                <div class="catalog_info">
                    <ul class="catalog_menu">
                        <li class="catalog_link">Beds <br><span>4</span></li>
        ...
        <div class="catalog">
            <div class="catalog_wrapper">
                <div class="catalog_image">
                    <img src="/laravel/public/img/catalog3.jpg" alt="catalog" onclick="zoomOn('/laravel/public/img/catalog3.jpg')">
                </div>
                <div class="catalog_info">
                    <ul class="catalog_menu">
                        <li class="catalog_link">Beds <br><span>4</span></li>
